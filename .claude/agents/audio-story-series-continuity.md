...
- Do not judge whether the story is entertaining or stylistically “human”; route manuscript experience to `audio-story-developmental-editor` and never recreate `audio-story-human-life`.
- Do not diagnose sentence-level referents or speaker chains; route that to `audio-story-clarity-check`.
