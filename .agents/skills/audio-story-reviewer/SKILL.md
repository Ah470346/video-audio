...
| Category | Record |
|---|---|
| Characters | name, aliases, role, goal, fear, knowledge, secrets |
...
- Read [references/grammar.md](references/grammar.md) for grammar, punctuation, wording, sentence flow, AI-like cadence, and listenability at the line level.
...
- Read [references/dialogue.md](references/dialogue.md) for direct dialogue, narrator-led compression, subtext, speaker clarity, xung ho, and natural Vietnamese speech.
...
- Read [references/audio.md](references/audio.md) for audiobook clarity, TTS readiness, names, numbers, abbreviations, pronunciation, and cold-listening checks.
...
| 2 | Audit grammar, wording, punctuation, sentence length, pronoun clarity, repeated cadence, and TTS-unfriendly text. | `grammar.md`, `audio.md` |
| 3 | Segment scenes by entry condition, immediate goal, obstacle, key event, turn/result, emotion, bridge, and function; test boundary stacks across protagonist, time, space, causality, and intention. | `narrator.md`, `pacing.md` |
| 4 | Check POV, narrator voice, focalization, tense, knowledge boundaries, and accidental mind-hopping. | `narrator.md` |
...
| 10 | Review emotional authenticity, residue, melodrama, catharsis, and evidence-based flatness symptoms. | `emotion.md` |
| 11 | Test dialogue value, subtext, speaker clarity, tactics, narrator-led compression, and natural Vietnamese speech. | `dialogue.md` |
| 12 | Perform a cold-listening pass as if the listener cannot see paragraph breaks, quotation marks, or formatting. | `audio.md` |
...
| Audio clarity and listenability | 6 |
| **Total** | **100** |
...
- Keep the readiness verdict independent from the total. Any unresolved P0, or a P1 that breaks the central causality, climax, ending, speaker identity, or pronunciation of essential information, can make the manuscript not ready even when the arithmetic score is high.
...
3. **Audio polish:** grammar, punctuation, rhythm, pronunciation.
...
State whether the story fulfills its genre promise, the highest-return change, recording readiness, and what must be rechecked after revision.

## Final Discipline Checklist

Before finalizing, confirm that the review is complete or clearly labeled partial; quotes are exact; global claims are supported by evidence; structural issues are prioritized before line polish; narrator-led compression is respected; flatness symptoms are evidence-based; and the recording-readiness verdict is clear.
